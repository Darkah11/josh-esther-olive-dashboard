...
import eggs from '../public/food/eggs.png'
        ...
        <div className=" mt-10">
          <table className=" w-full bg-bgColor table-container rounded-t-xl">
            <thead className=" bg-primary text-bgColor">
              ...
              <th className=" border-r text-left p-4 font-semibold">Name</th>
              ...
              {data &&
                rows.map((item) => (
                  <tr key={item.id} className=" table-row">
                    <td className=" border-r border-t w-[10%] p-4 capitalize font-semibold text-sm">
                     
                      {/* <Image src={eggs} alt="breakfast" width={40} height={40}/> */}
                      <Image src={item.img} alt="breakfast" width={40} height={40}/>
                    </td>
                    <td className=" border-r w-[50%] p-4 border-t capitalize text-sm font-medium">
                      {item.name}
                    </td>
                    <td className=" border-r w-[20%] p-4 border-t">
                    ₦{item.price}
                    </td>
                    <td className=" w-[20%] p-4 border-t">
                      <div className=" flex flex-row gap-2">
                        <Link href={`/${path}/edit/${item.id}`}>
                          <svg
                            width="25"
                            height="24"
                            viewBox="0 0 25 24"
                          ...
                          >
                            <path
                              d="M9.75 7H6.75C5.64543 7 4.75 7.89543 4.75 9V18C4.75 19.1046 5.64543 20 6.75 20H15.75C16.8546 20 17.75 19.1046 17.75 18V15"
                              stroke="#2C2B2B"
                              strokeWidth="1.75"
                              strokeLinecap="round"
                            ...
                            />
                            <path
                              d="M9.75 15H12.75L21.25 6.49998C22.0784 5.67156 22.0784 4.32841 21.25 3.49998C20.4216 2.67156 19.0784 2.67156 18.25 3.49998L9.75 12V15"
                              stroke="#2C2B2B"
                              strokeWidth="1.75"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                        ...
                        <button onClick={() => handleDelete(item.id)}>
                          ...
                          >
                            ...
                            />
                            <path
                              d="M5.75 7L6.75 19C6.75 20.1046 7.64543 21 8.75 21H16.75C17.8546 21 18.75 20.1046 18.75 19L19.75 7"
                              stroke="#2C2B2B"
                              strokeWidth="1.75"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                            />
                            <path
                              d="M9.75 7V4C9.75 3.44772 10.1977 3 10.75 3H14.75C15.3023 3 15.75 3.44772 15.75 4V7"
                              stroke="#2C2B2B"
                              strokeWidth="1.75"
                              strokeLinecap="round"
                              strokeLinejoin="round"
